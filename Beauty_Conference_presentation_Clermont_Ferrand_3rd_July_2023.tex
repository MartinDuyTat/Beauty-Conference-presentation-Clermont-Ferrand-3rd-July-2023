...
\begin{frame}{Phase-space binned $B^\pm\to[K^+K^-\pi^+\pi^-]_DK^\pm$}
  ...
  \begin{center}
    ...
    LHCb-PAPER-2022-037, \href{https://arxiv.org/abs/2301.10328}{arXiv:2301.10328} (accepted by EPJC)
  \end{center}
\end{frame}
...
\begin{frame}{Phase-space binned $B^\pm\to[K^+K^-\pi^+\pi^-]_DK^\pm$}
  ...
  \end{figure}
  \begin{itemize}
    \item{$B^\pm\to[K^+K^-\pi^+\pi^-]h^\pm$ signal yield:}
    \begin{itemize}
...
\begin{frame}{Summary and conclusion}
  \begin{enumerate}
    ...
    \end{itemize}
    \item{Additionally, a binned measurement with the channel $B^\pm\to[K^+K^-\pi^+\pi^-]K^\pm$ has been performed for the first time}
    \begin{itemize}
